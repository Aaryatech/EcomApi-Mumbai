...
public class DelBoyOrderGriev {
    ...
    private int dDate; //ie orderId in tn_grievences
    private int grivId; //ie primary key of tn_grievences
	...
	public int getGrivId() {
		return grivId;
	}

	public void setGrivId(int grivId) {
		this.grivId = grivId;
	}
