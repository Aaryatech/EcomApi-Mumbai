...
public class GetTnOrderHeader {
	...
	@Transient
	private List<GetTnOrderDetails> tnOrderlist;
	...
	public List<GetTnOrderDetails> getTnOrderlist() {
		return tnOrderlist;
	}
	public void setTnOrderlist(List<GetTnOrderDetails> tnOrderlist) {
		this.tnOrderlist = tnOrderlist;
	}
	@Override
	public String toString() {
		return "GetTnOrderHeader [orderId=" + orderId + ", orderNo=" + orderNo + ", orderDate=" + orderDate + ", frId="
				...
				+ ", isAgent=" + isAgent + ", uuidNo=" + uuidNo + ", tnOrderlist=" + tnOrderlist + "]";
	}
