...
public interface GetProdListRepo extends JpaRepository<GetProdList, Integer> {
	 ...
	 * +
	 * " and m_product.del_status=1 and m_product.company_id=:compId ORDER BY m_product.sort_id DESC  "
	 * , nativeQuery = true) List<GetProdList> getProdList(@Param("compId") int
	 * compId);
	 */
