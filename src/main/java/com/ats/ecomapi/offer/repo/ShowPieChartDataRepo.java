...
public interface ShowPieChartDataRepo extends JpaRepository<ShowPieChartData, Integer> {
	...
	@Query(value="SELECT\n" + 
			...
			"        h.payment_method =:paymentMethod and h.fr_id=:frId\n" + 
			"    GROUP BY c.cat_id",nativeQuery=true)
	List<ShowPieChartData> getCatQtyChartByFr(@Param("fromDate") String fromDate, @Param("toDate") String toDate, 
	...
	@Query(value="SELECT\n" + 
			...
			"        h.payment_method =:paymentMethod and h.fr_id=:frId \n" + 
			"    GROUP BY sub_cat.sub_cat_id",nativeQuery=true)
	List<ShowPieChartData> getSubCatQtyChartByFr(@Param("catId") int catId, @Param("fromDate") String fromDate, @Param("toDate") String toDate, 
			@Param("orderStatus") List<String> orderStatus, @Param("compIds") List<String> compIds, 
			@Param("paymentMethod") int paymentMethod , @Param("frId") int frId);
	...
	@Query(value="SELECT\n" + 
			...
			"        AND   h.delivery_date BETWEEN :fromDate AND :toDate \n" + 
			"        AND   h.order_status IN(:orderStatus) \n" + 
			"        AND   h.payment_method =:paymentMethod and h.fr_id=:frId    \n" + 
			"    GROUP BY\n" + 
			"        c.cat_id",nativeQuery=true)
	List<ShowPieChartData> getCatTotalSaleChartByFr(@Param("fromDate") String fromDate, @Param("toDate") String toDate, 
			@Param("orderStatus") List<String> orderStatus, @Param("compIds") List<String> compIds, 
			@Param("paymentMethod") int paymentMethod, @Param("frId") int frId);
